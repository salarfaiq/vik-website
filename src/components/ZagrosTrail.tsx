        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          <ScrollReveal direction="right">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6">
              The Zagros{" "}
              <span className="text-gradient-sage">Mountain Trail</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {[
                ...
                <div key={stat.label} className="glass-card rounded-xl px-4 py-3 text-center">
                  <div className="text-[var(--vik-sage)] font-bold text-lg">{stat.value}</div>
        ...
        <ScrollReveal>
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--foreground)]/45 mt-2">
              Next departure: <strong className="text-[var(--vik-sage)]">March 19-31, 2026</strong> — coinciding with Nawroz, the Kurdish New Year.
            </p>
          </div>
        </ScrollReveal>
            ...
            {ZMT_DAYS.map((day, i) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  activeDay === i
                    ? "bg-[var(--vik-sage)]/15 border border-[var(--vik-sage)]/30 text-[var(--vik-sage)]"
                    : "border border-[var(--vik-border-storm)] text-[var(--foreground)]/40 hover:text-[var(--vik-sage)]"
                }`}
              >
                {day.label}
              </button>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-[var(--vik-sage)] text-xl font-bold">{ZMT_DAYS[activeDay].label}</span>
