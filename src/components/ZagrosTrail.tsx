        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          <ScrollReveal direction="right">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6">
              The Zagros{" "}
              <span className="text-gradient-ember">Mountain Trail</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {[
                ...
                <div key={stat.label} className="glass-card rounded-xl px-4 py-3 text-center">
                  <div className="text-[var(--vik-ember)] font-bold text-lg">{stat.value}</div>
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-[var(--vik-ember-dark)] to-[var(--vik-ember)] text-white font-bold hover:shadow-lg hover:shadow-[var(--vik-glow)] transition-all duration-300 hover:scale-105"
            >
              Reserve Your Spot →
            </a>
          </ScrollReveal>
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="glass-card rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[var(--vik-warm)]/15 flex items-center justify-center">
                      <span className="text-[var(--vik-warm)]">★</span>
                    </div>
                    <div>
        ...
        <ScrollReveal>
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--foreground)]/45 mt-2">
              Next departure: <strong className="text-[var(--vik-ember)]">March 19-31, 2026</strong> — coinciding with Nawroz, the Kurdish New Year.
            </p>
          </div>
        </ScrollReveal>
            ...
            {ZMT_DAYS.map((day, i) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  activeDay === i
                    ? "bg-[var(--vik-ember)]/15 border border-[var(--vik-ember)]/30 text-[var(--vik-ember)]"
                    : "border border-[var(--vik-border-storm)] text-[var(--foreground)]/40 hover:text-[var(--vik-ember)]"
                }`}
              >
                {day.label}
              </button>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-[var(--vik-ember)] text-xl font-bold">{ZMT_DAYS[activeDay].label}</span>
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <ScrollReveal delay={0.1}>
            <h4 className="text-lg font-bold mb-4 flex items-center gap-2">
              <span className="text-[var(--vik-glacier)]">✓</span> What&apos;s Included
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-[var(--foreground)]/45 text-sm">
                  <span className="text-[var(--vik-glacier)] mt-0.5">✓</span> {item}
                </li>
              ))}
            </ul>
          </ScrollReveal>
