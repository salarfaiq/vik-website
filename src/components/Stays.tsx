        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">
              Mountain Stays &{" "}
              <span className="text-gradient-gold">Glamping</span>
            </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {STAYS.map((stay, index) => (
            <ScrollReveal key={stay.name} delay={index * 0.1}>
              <div className="glass-card rounded-2xl overflow-hidden group hover:border-[var(--vik-gold)]/20 transition-all duration-300 h-full">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[var(--vik-gold)] font-bold">
