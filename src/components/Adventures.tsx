        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">
              ...
              <span className="text-gradient-sage">the Soul</span>
            </h2>
          ...
          <ScrollReveal delay={0.08} className="lg:col-span-2 lg:row-span-2">
            <a href="#zagros" className="block rounded-2xl overflow-hidden relative group cursor-pointer h-full min-h-[400px]">
              ...
              <div className="absolute top-4 left-4 flex gap-2">
                <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[var(--vik-sage)] text-white">FLAGSHIP</span>
                <span className="px-3 py-1 rounded-full text-xs font-semibold diff-hard">{flagship.duration}</span>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                <div className="text-[var(--vik-sage)] text-sm font-semibold tracking-wide mb-2">{flagship.tag}</div>
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  <span className="text-2xl font-bold text-[var(--vik-sage)]">{flagship.price}</span>
